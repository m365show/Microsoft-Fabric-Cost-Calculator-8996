...
const EmbedWidescreenCalculator = ({ darkMode }) => {
  ...
  return (
    <div className={`w-full h-full flex flex-col ${
      ...
      <div className="flex-1 flex">
        ...
        <div className={`w-1/3 p-6 border-l ${darkMode ? 'bg-gray-700 border-gray-600' : 'bg-gray-50 border-gray-200'}`}>
          ...
          <div className="space-y-4">
            ...
            {Object.entries(config.workloads)
              ...
              .map(([key, workload]) => {
                ...
                return (
                  <div key={key} className={`p-4 rounded-lg ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
                    <div className="flex justify-between items-center mb-2">
...
export default EmbedWidescreenCalculator;